    ...
    return (
        <div>
            <nav className="bg-blue border-gray-200 dark:bg-gray-900">
                <div className="flex fl ex-wrap justify-between items-center mx-auto max-w-screen-xl p-2">
                    <a href="#" >
                    ...
                    <ul className="flex items-stretch">
                        <li>
                            <Link
                                to="/farmproducts"
                                className="text-white md:bg-transparent dark:text-white text-1x"
                                aria-current="page"
                            >
                                <HomeIcon />                            </Link>
                        </li>
            ...
            <div className="flex items-stretch ml-12 space-x-16 px-14 py-8">
            ...
            <div className="flex items-stretch ml-12 px-14 py-2">
                <div className="relative m-10 flex w-full max-w-xs flex-col overflow-hidden rounded-lg border border-gray-100 bg-white shadow-md">
                    <a className="relative mx-3 mt-3 flex h-60 overflow-hidden rounded-xl" href="#">
                        <img className="object-cover" src="https://images.unsplash.com/photo-1600185365483-26d7a4cc7519?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8OHx8c25lYWtlcnxlbnwwfHwwfHw%3D&auto=format&fit=crop&w=500&q=60" alt="product image" />
                        <span className="absolute top-0 left-0 m-2 rounded-full bg-black px-2 text-center text-sm font-medium text-white">39% OFF</span>
